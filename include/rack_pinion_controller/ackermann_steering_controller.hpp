...
public:
  ...
  // Объявление метода calculate_rack_position
  ACKERMANN_STEERING_CONTROLLER__VISIBILITY_PUBLIC double calculate_rack_position(
    double right_pos, double left_pos, double radius_rotation);
